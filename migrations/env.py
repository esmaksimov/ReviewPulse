...
from reviewpulse.config import get_settings
from reviewpulse.db.models import Base
...
# The URL comes from the same settings the bot uses, so migrations can never be
# pointed at a different database than the one running.
